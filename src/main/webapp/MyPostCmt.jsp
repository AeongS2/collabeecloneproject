...
<section class="left_tab_sec1 column">	<!-- 레프트 빼고 전체-->
	...
	<div id="title_mp" class="row">
		<div id="mypost_title"><a href="myPostCmt.jsp">내가 작성한 문서</a></div>
	...
	$(function(){
		...
		$(".posting_bnt").click(function(){
			location.href="Document.jsp?workspaceId=4&workspaceName=프라이빗 공간";
		});

		//내가 작성한 문서 보기
		$("#mypost").on("click", function(){
			location.href="MyPostCmt.jsp?workspaceId=4&workspaceName=프라이빗 공간";
		});
			
			$.ajax({
				type:"post",
				url:"Controller?command=MyPost",
				data:{
					"loginId":4
				},
				datatype:"json",
...
%>	 --%>	
	...
	<section id="myPostCommentList" class="left_tab_sec2 none">
	<!-- 	
		<div class="postbox_mp1 row">			
			<div class="icon_mp"><svg viewBox="0 0 24 24" width="21px" height="21px"><path d="M5.6 4h12.8c.88 0 1.6.72 1.6 1.6V20l-3.2-3.2H5.6c-.88 0-1.6-.72-1.6-1.6V5.6C4 4.72 4.72 4 5.6 4z" color="#888888"></path></svg></div>
			<div class="post_info column">
...
<%@ include file="../WEB-INF/include/include_ScheduleModal2.jspf" %>
<%@ include file="../WEB-INF/include/include_postedSchedule.jsp" %>
</body>
</html>