...
<%
	...
	ArrayList<NoneFolderDto> listNone = hDao.getHomeWorkspace(2);
	//int corporation_id = hDao.gotCorporation(1);
	//int corporation_manager = hDao.gotManager(1);
...
<head>
	...
	.home_sidebar html::-webkit-scrollbar {
		width:4px;
	}
	.home_sidebar html::-webkit-scrollbar-thumb {
	    height: 70%; /* 스크롤바의 길이 */
	    background-color: #e1e1e1; /* 스크롤바의 색상 */
	    border-radius: 2px;
	}
	.home_sidebar html::-webkit-scrollbar-track{
	...
	.calendar_selection::-webkit-scrollbar {
		width:4px;
	}
	.calendar_selection::-webkit-scrollbar-thumb {
	    height: 70%; /* 스크롤바의 길이 */
	    background: #e1e1e1; /* 스크롤바의 색상 */
	    border-radius: 2px;
	}
	...
	input[id="calendar-total"]:checked + label{
		background-color: black;
	}
	input[id="calendar-private"]:checked + label{
		background-color: rgb(217, 173, 43);
	}
	input[id="calendar-cor1"]:checked + label{
		background-color: rgb(61, 150, 41);
	}
	input[id="calendar-w1"]:checked + label{
		background-color: rgb(255, 121, 19);
	}
	input[id="calendar-w2"]:checked + label{
		background-color: rgb(113, 48, 179);
	}
	input[id="calendar-w3"]:checked + label{
		background-color: rgb(71, 73, 143);
	}
	input[id="calendar-w4"]:checked + label{
		background-color: rgb(241, 58, 119);
	}
	input[id="calendar-w5"]:checked + label{
	...
	<script>
	$(function(){
		/*지현이가 사용할 쿼리 $('.calendar_button').click(function (){
...
<body style="overflow-x: hidden;">
	...
	<!-- 골라진 거 menu클라스 옆에 chosen 클래스 붙이면 선택된 것처럼 나옴  name에는 bold를 붙이고-->		
			<div class="left-navigation">
				...
				<a class="menu" href="updatebar2.html">
	...
	<!-- 여기서부터 캘린더공간 -->				
				<!-- <div class="calendar_selection">
					<div class="calendar2">
						<input type="checkbox" id="calendar-total"/>
						<label for="calendar-total"></label>
						<div class="name" style="padding-left: 2px;">전체 공간</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-private" name="cld"/>
						<label for="calendar-private"></label>
						<div class="name" style="padding-left: 2px;">프라이빗 공간</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-cor1" name="cld"/>
						<label for="calendar-cor1"></label>
						<div class="name" style="padding-left: 2px;">모두의 공간</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-w1" name="cld"/>
						<label for="calendar-w1"></label>
						<div class="name" style="padding-left: 2px;">연봉111조</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-w2" name="cld"/>
						<label for="calendar-w2"></label>
						<div class="name" style="padding-left: 2px;">[샘플] 앱 리뉴얼 프로젝트</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-w3" name="cld"/>
						<label for="calendar-w3"></label>
						<div class="name" style="padding-left: 2px;">코드공유 공간</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-w4" name="cld"/>
						<label for="calendar-w4"></label>
						<div class="name" style="padding-left: 2px;">프로젝트</div>
					</div>
					<div class="calendar2">
						<input type="checkbox" id="calendar-w5" name="cld"/>
						<label for="calendar-w5"></label>
						<div class="name" style="padding-left: 2px;">[샘플] 서비스 배포(웹/모바일)</div>
					</div>
				</div> -->
...
<!-- 여기서부터도 유라만족용 -->
		<!-- <div class="folder2">
			<div class="f_container" type="f">draggable="true"
					<svg viewBox="0 0 24 24" width="12px" height="12px" class="home_svg4"><path d="M8 5.4A2.2 2.2 0 1 1 8 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zM8 23a2.2 2.2 0 1 1 0-4.4A2.2 2.2 0 0 1 8 23zm8-17.6A2.2 2.2 0 1 1 16 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4z" color="#C1C1C1" class="Beecon__Path-sc-3x6pq4-1 dBeMQs"></path></svg>
					<div class="f_container2">
						<div class="f_container4" title="정처기">
							<div class="f_name">정처기</div>
							<button class="home_btn3">
								<svg viewBox="0 0 24 24" width="14px" height="14px" class="home_svg22"><path d="M19 15H5l7-7z" class="Beecon__Path-sc-3x6pq4-1 jRUwgg"></path></svg>
							</button>
						</div>
					</div>
					<button class="home_btn1">
						<svg viewBox="0 0 24 24" width="16px" height="16px" class="home_svg2"><path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" class="Beecon__Path-sc-3x6pq4-1 jRUwgg" style="visibility:inherit"></path></svg>
					</button>
				</div>
				<div class="w_list">
					<div class="f_container" type="p">draggable="true"
						<svg viewBox="0 0 24 24" width="12px" height="12px" class="home_svg4"><path d="M8 5.4A2.2 2.2 0 1 1 8 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zM8 23a2.2 2.2 0 1 1 0-4.4A2.2 2.2 0 0 1 8 23zm8-17.6A2.2 2.2 0 1 1 16 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4z" color="#C1C1C1" class="Beecon__Path-sc-3x6pq4-1 dBeMQs"></path></svg>
						<div class="f_container2">
							<div class="f_container3">
								<div>
									<svg viewBox="0 0 24 24" width="16px" height="16px" class="home_svg5"><path d="M14.027 5L13.6 3H4v18h2v-7h6l.533 2H20V5z" class="Beecon__Path-sc-3x6pq4-1 jRUwgg"></path></svg>
								</div>
								<div style="margin-top: 5px;" class="name" title="코드공유 공간">코드공유 공간</div>
							</div>
						</div>
					</div>
					...
					<div class="f_container" type="p">draggable="true"
						...
						<div class="f_container2">
							<div class="f_container3">
								...
								<div style="margin-top: 5px;" class="name" title="프로젝트">프로젝트</div>
							</div>
						</div>
					</div>
					...
					<div class="f_container" type="p">draggable="true" 
						...
						<div class="f_container2">
							<div class="f_container3">
								...
								<div style="margin-top: 5px;" class="name" title="연봉111조">연봉111조</div>
							</div>
						</div>
					</div>
				</div>
			
				<div class="f_container" draggable="true" type="f">
					<svg viewBox="0 0 24 24" width="12px" height="12px" class="home_svg4"><path d="M8 5.4A2.2 2.2 0 1 1 8 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zM8 23a2.2 2.2 0 1 1 0-4.4A2.2 2.2 0 0 1 8 23zm8-17.6A2.2 2.2 0 1 1 16 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4z" color="#C1C1C1" class="Beecon__Path-sc-3x6pq4-1 dBeMQs"></path></svg>
					<div class="f_container2">
						<div class="f_container4" title="IT 프로젝트">
							<div class="f_name">IT 프로젝트</div>
							<button class="home_btn3">
								<svg viewBox="0 0 24 24" width="14px" height="14px" class="home_svg22"><path d="M19 15H5l7-7z" class="Beecon__Path-sc-3x6pq4-1 jRUwgg"></path></svg>
							</button>
						</div>
					...
					<div class="f_container" type="p">draggable="true"
						...
						<div class="f_container2">
							<div class="f_container3">
								...
								<div style="margin-top: 5px;" class="name" title="[샘플] 앱 리뉴얼 프로젝트">[샘플] 앱 리뉴얼 프로젝트</div>
							</div>
						</div>
					</div>
					...
					<div class="f_container" type="p">draggable="true"
						...
						<div class="f_container2">
							<div class="f_container3">
								...
								<div style="margin-top: 5px;" class="name" title="[샘플] 앱 리뉴얼 > QA테스트">[샘플] 앱 리뉴얼 > QA테스트</div>
							</div>
						</div>
					</div>
					...
					<div class="f_container" type="p">draggable="true" 
						...
						<div class="f_container2">
							<div class="f_container3">
								...
								<div style="margin-top: 5px;" class="name" title="[샘플] 서비스 배포(웹/모바일)">[샘플] 서비스 배포(웹/모바일)</div>
							</div>
						</div>
					</div>
				</div>
				<div class="f_container" draggable="true" type="f">
					<svg viewBox="0 0 24 24" width="12px" height="12px" class="home_svg4"><path d="M8 5.4A2.2 2.2 0 1 1 8 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zM8 23a2.2 2.2 0 1 1 0-4.4A2.2 2.2 0 0 1 8 23zm8-17.6A2.2 2.2 0 1 1 16 1a2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4zm0 8.8a2.2 2.2 0 1 1 0-4.4 2.2 2.2 0 0 1 0 4.4z" color="#C1C1C1" class="Beecon__Path-sc-3x6pq4-1 dBeMQs"></path></svg>
					<div class="f_container2">
						<div class="f_container4" title="경영/사업">
							<div class="f_name">경영/사업</div>
							<button class="home_btn3">
								<svg style="transform: scaleY(-1);" viewBox="0 0 24 24" width="14px" height="14px" class="home_svg22"><path d="M19 15H5l7-7z" class="Beecon__Path-sc-3x6pq4-1 jRUwgg"></path></svg>
							</button>
						</div>
					</div>
					<button class="home_btn1">
